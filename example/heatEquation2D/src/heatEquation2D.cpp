...
auto example(T_Cfg const& cfg) -> int
{
    ...
    StencilKernel<alpaka::CVec<int, 1, 1>, alpaka::CVec<int, 1, 7>, alpaka::CVec<int, 4, 4>> stencilKernel;
    ...
    auto tuningSession
        = tune::TuningBuilder{}
              ...
              //.withNumBlocksTune(
              // tune::Tuneable<fVec, 0, tune::DimensionsDependent>(
              // uVec{1, 1},
              // IdxRange{uVec{1, 1}, uVec{3, 4}, uVec{1, 1}}))
