...
#include <alpaka/tune/utils/processVariadicArgs.hpp>
...
namespace alpaka::tune
{
    ...
    public:
         ...
         *
         * @tparam TuneableIDs Variadic list of tuneable identifiers.
         ...
         * auto builder = TuningBuilder{}
         *     .withConstraint<frame::numThreads, frame::frameExtent>(
         *         [] (auto threads, auto extent) {
         *             return allTrue(threads <= extent);
         *         });
         * @endcode
         */
        ...
        auto withConstraint(T_Predicate&& pred)
        {
            ...
            auto constraint = alpaka::tune::constraint::Constraint<CleanPredicate, TuneableIDs...>{
        ...
        /**
         * @brief Specify the output file for tuning session results.
         *
         * The output file stores parameter configurations and their measured metrics in a .toml file.
        ...
        TuningBuilder& withContextSpecifier(T_Specifiers... specifiers)
        {
            static_assert(
                ...
                "type.");
            alpaka::tune::detail::processArgs(m_sessionSpecifiers, specifiers...);
            return *this;
        }
    ...
    private:
        ...
        {
            return alpaka::tune::constraint::Constraint<T_Predicate, TuneableIDs...>{pred};
        }
