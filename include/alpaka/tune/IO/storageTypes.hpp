...
namespace alpaka::tune::config
{
    ...
    inline Comparison kruskalCompare(
        alpaka::tune::config::ConfigEntry<T_Config>& current,
        alpaka::tune::config::ConfigEntry<T_Config>& other)
    {
...
namespace alpaka::tune::IO
{
    ...
    {
    public:
        using Entry = alpaka::tune::config::ConfigEntry<TConfig>;
        ...
        bool remove(alpaka::tune::config::ConfigEntry<TConfig> const& configEntry)
        {
        ...
        bool contains(alpaka::tune::config::ConfigEntry<TConfig> const& config) const
        {
