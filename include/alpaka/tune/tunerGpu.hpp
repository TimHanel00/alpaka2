    ...
    namespace alpaka::onHost::internal
    {
        template<
                       ...
                       struct AdjustThreadSpec::
                           Op<unifiedCudaHip::Device<T_Platform>, T_Mapping, FrameSpec<T_NumBlocks, T_NumThreads>, T_KernelBundle,trait::useTuner_v>
        {
            auto operator()(
...
namespace alpaka::tune
    {
        ...
        {
            auto operator()(
                alpaka::onHost::unifiedCudaHip::Device<T_Platform> & device,
                T_Mapping const& executor,
