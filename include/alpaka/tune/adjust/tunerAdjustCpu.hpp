...
namespace alpaka::tune
{
    ...
    template<typename T_NumBlocks, typename T_NumThreads,typename T_ThreadSpec, typename T_KernelRun>
...
#define NrOfFrameExtentConfigs 20
    ...
    auto applyHwConstraints(
        ...
        T_Exec exec,
        onHost::FrameSpec<T_NumBlocks, T_NumThreads, T_ThreadSpec> const& frameSpec,
        T_KernelRun& run)
    { // always apply current frameTuning
        ...
        return std::make_pair(
            onHost::FrameSpec<T_NumBlocks, T_NumThreads, T_ThreadSpec>(
    ...
    // serial
    template<typename T_Platform, typename T_Kind, typename T_NumBlocks, typename T_NumThreads,typename T_ThreadSpec, typename T_KernelRun>
