...
#define defaultMaxSteps 32
    ...
    template<typename T_NumFrames, typename T_NumThreads,typename T_ThreadSpec, typename T_activeKernel>
    void clampToSpec(
        auto& device,
        onHost::FrameSpec<T_NumFrames,T_NumThreads,T_ThreadSpec>& frameSpec,
