...
namespace alpaka::rand::distribution
{
    ...
    private:
        ...
        constexpr auto engineDispatch(T_Engine& engine) -> T_Result
        {
            ...
            T_Result res = internal::getNormalizedUniformReal<T_Interval, T_Result, TdispatchWrapper>(dispatchWrapper);
            return scaleInterval(res);
        }
         ...
         * maintainers should consider creating a constexpr adaption of std::nextafter
         *
