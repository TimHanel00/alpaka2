...
#include "alpaka/rand/engines/philox/PhiloxSingle.hpp"
#include "alpaka/rand/engines/philox/PhiloxVector.hpp"
...
namespace alpaka::rand::engine
{
    ...
    public:
        ...
        using EngineParams = alpaka::rand::internal::engine::PhiloxParams<4, 32, 10>;
        /// Engine outputs a single number
        using EngineVariant = alpaka::rand::internal::engine::PhiloxSingle<EngineParams>;
    ...
    {
    public:
        using EngineParams = internal::engine::PhiloxParams<4, 32, 10>;
        using EngineVariant = internal::engine::PhiloxVector<EngineParams>;
