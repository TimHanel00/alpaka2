...
#include "alpaka/rand/engines/philox/PhiloxConstants.hpp"
#include "alpaka/rand/engines/philox/multiplyAndSplit64to32.hpp"
...
namespace alpaka::rand::internal::engine
{
    ...
    protected:
        ...
        static ALPAKA_FN_HOST_ACC auto singleRound(Counter const& counter, Key const& key)
        {
            ...
            helper::multiplyAndSplit64to32(counter[0], PhiloxConstants::MULTIPLITER_4x32_0(), H0, L0);
            helper::multiplyAndSplit64to32(counter[2], PhiloxConstants::MULTIPLITER_4x32_1(), H1, L1);
