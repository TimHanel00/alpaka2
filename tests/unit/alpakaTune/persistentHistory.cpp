...
#include "alpaka/tune/IO/runTimeHistory.hpp" // <- adjust include if needed; your provided code block’s header name
...
static void set_record_state_to_ready(
    alpaka::tune::IO::ActiveHistory<TConfig>& hist,
    TConfig const& cfg,
    std::vector<double> samples)
{
    using Entry = typename alpaka::tune::IO::ActiveHistory<TConfig>::Entry;
...
TEST_CASE("PersistentHistory::write creates JSON with expected number of configs", "[PersistentHistory][write]")
{
    ...
    alpaka::tune::IO::ActiveHistory<ConfigT> history;
    ...
    "[PersistentHistory][read][write]")
{
    ...
    alpaka::tune::IO::ActiveHistory<ConfigT> histW;
    ...
    alpaka::tune::IO::ActiveHistory<ConfigT> histR;
    ...
    "[PersistentHistory][CTunable][read][write]")
{
    ...
    alpaka::tune::IO::ActiveHistory<ConfigT> histR_same;
    ...
    alpaka::tune::IO::ActiveHistory<ConfigT> histR_diff;
